...
console.log("დღეს არის: " + dayName);

console.log("mgoni es unda meqna da kompic 0 dan iwyebs anu kviris dgebs ");
...
for (let i = 0; i < characters.length; i++) {
  if (characters[i].yearOfBirth >= 1980 && characters[i].hogwartsStudent === true) {
    console.log("es jadoqari akmayofilebs chven pirobas --- " + characters[i].name);
  }
}
